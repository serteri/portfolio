...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      className="mb-28 max-w-[50rem] text-center ms:mb-0 scroll-mt-[100rem]"
      id="home"
    >
      ...
      >
        <span className="font-bold">Hello I'm Serter Iyigunlu.</span> I am a{" "}
